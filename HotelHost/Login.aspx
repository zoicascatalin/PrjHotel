<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Login.aspx.cs" Inherits="HotelBase.Login" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlBody">
        <div style="width: 40%; text-align: center; justify-content: center; margin: 0 auto;">
            ...
            <div>
                <asp:CheckBox runat="server" ID="chkRemember" Checked="true" OnCheckedChanged="chkRemember_CheckedChanged" />
            </div>
            <div>
